    ...
    <div className={className}>
      ...
      >
        <Modal.Content>
          ...
          <BodyLong spacing>
            Dataen finnes ikke utenfor enheten din. Sletting av data fører kun
            til at alle oppgaver markeres som ikke fullført.
          </BodyLong>
          <div className="flex gap-2">
            <Button onClick={() => setRequestDeletion(false)}>
              Nei, glem det
            </Button>
